...
if __name__ == "__main__":
    ...
    API_KEY = "papi.e5d0316e-ecda-4492-81b8-ef3eb2d67217.NGMZSBn8CyybBvHMhRIe21iStJGJe9rU"

    # Membuat objek dari kelas
    reve = ReveAPI(API_KEY)

    # Menghasilkan gambar
    reve.generate_reve_image(
        "meteor yang jatuh di atas kota futuristik pada malam hari"
    )
